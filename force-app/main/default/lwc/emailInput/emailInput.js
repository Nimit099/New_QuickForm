...
export default class EmailInput extends LightningElement {
    ...
    handleBlur(){
        console.log("onblur");
        // this.input = 'slds-hide';
        var a = this.template.querySelector(".input");
        console.log(a);
   ...
   /* handleBlur() {
        ...
        this.blurTimeout = setTimeout(() => {
            ...
            var index = this.template.querySelector("index");
            for (let i = 0; i < input.length; i++) {
                if(i != parseInt(index)){
                    console.log({index});
                    // const element = (input[index],'slds-hide');
                    this.template.querySelector('input').classList.add('slds-hide');
                }
            }
            // const value = this.template.querySelector('.input');
            // console.log({value});
